...
```{r, ggplot2totnumstepsnonimputed, echo=TRUE}
...
```{r, simpleplotHistostepsdaysnonimputedecho=TRUE}
...
```{r, simpleplotintervalmeannonimputedecho = TRUE}
...
```{r, simpleplothistodaystepimputedecho = TRUE}
  x <- (isteps_day$Steps)
...
```{r, latticeistepsintervalmeanwk, echo = TRUE, fig.height=5}
 xyplot(Steps_mean ~ Interval | Weekday, data = isteps_interval_mean_wk, type = "l" , layout = c(1,2), xlab="Time of day", ylab="Average steps", 
